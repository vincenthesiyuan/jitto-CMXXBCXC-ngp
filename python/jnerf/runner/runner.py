...
class Runner():
    def __init__(self):
        ...
        self.exp_index          = self.cfg.exp_index
        self.dataset            = {}
        ...
        self.comp_save_path     = self.cfg.comp_save_path
        if not os.path.exists(self.save_path):
            os.makedirs(self.save_path)
        if self.cfg.ckpt_path and self.cfg.ckpt_path is not None:
            self.ckpt_path = os.path.join(self.cfg.ckpt_path, "params.pkl")
        else:
    ...
    def test(self, load_ckpt=False):
        ...
        if not os.path.exists(self.comp_save_path):
            os.makedirs(self.comp_save_path)
        mse_list=self.render_test(save_path=self.comp_save_path)
