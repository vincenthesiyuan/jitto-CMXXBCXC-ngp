...
dataset_dir = 'data/nerf_synthetic/'+exp_name
dataset_aabb = {"Car":8, "Coffee":1, "Easyship":8, "Scar":5, "Scarf":8}
...
log_dir = "./logs"
# jittor competition result path
comp_save_path = "./result"
ckpt_path = log_dir + "/" + exp_name
tot_train_steps = 50000
